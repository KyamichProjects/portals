(function () {
    ...
    function initDepositPageButtons() {
        ...
        const showTopToast = window.MarketUtils.showTopToast;
        ...
        const confirmExchange = async () => {
            ...
            try {
                ...
                const data = await window.MarketAPI.exchangeStars(starsToSpend);
    ...
    async function loadStarsAnimation() {
        ...
        starsAnimation = await window.MarketUtils.loadTgsAnimation('/market/Stic/AnimatedSticker.tgs', container, {
            wrapClass: 'lottie-star-container',
            wrapSize: '56px',
            fallbackHtml: '<svg width="48" height="48" viewBox="0 0 24 24" fill="#fbbf24"><path d="M12 2L15.09 8.26L22 9.27L17 14.14L18.18 21.02L12 17.77L5.82 21.02L7 14.14L2 9.27L8.91 8.26L12 2Z"/></svg>'
        });
    }

    function destroyStarsAnimation() {
        starsAnimation = window.MarketUtils.destroyAnimation(starsAnimation);
    }
    ...
    async function loadStarsHistory() {
        ...
        try {
            const data = await window.MarketAPI.getStarsHistory();
